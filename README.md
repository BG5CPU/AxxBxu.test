...
`SimB/Model_saturation_04.m` is for **Example 3** in the paper.  

`SimB/Data_stabilization_04.m` is for **Example 4** and **Example 5** in the paper.  

`SimB/Data_saturation_04.m` is for **Example 6** in the paper.  
...
The size of `ros.bag` is too big. It is available [here](https://nusu-my.sharepoint.com/:f:/g/personal/li_ld_nus_edu_sg/Esiid6VxqM9AnskADErBVK8BECar4wHoJvvaXhQw8TRjeQ?e=KSHiYJ). Fortunately, the rosbag has been converted to csv in this repository.
