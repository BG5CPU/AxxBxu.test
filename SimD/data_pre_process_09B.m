...
% file path
file1 = 'Gazebo_data_csv/sim_mpc_exp_1006B/imu_data.csv';
file2 = 'Gazebo_data_csv/sim_mpc_exp_1006B/attitude_r_p_y.csv';
file3 = 'Gazebo_data_csv/sim_mpc_exp_1006B/actuator_control.csv';
file4 = 'Gazebo_data_csv/sim_mpc_exp_1006B/input_x_y_z.csv';
file5 = 'Gazebo_data_csv/sim_mpc_exp_1006B/pose.csv';
...
matrix_input_x_y_z = matrix_input_x_y_z(2:end-1,:);
...
matrix_imu_data = matrix_imu_data(27:end,:);
figure(5); hold on;
...
matrix_attitude_r_p_y = matrix_attitude_r_p_y(1:end-1,:);
figure(6); hold on;
...
data_input_output_09B = [actuator_control_x, actuator_control_y, actuator_control_z, ...
...
Pstart01 = 2000;
Pend01 = 23000;
% data_input_output_09B = data_input_output_09B(Pstart01:Pend01 , :);
% save('./Gazebo_data_mat/data09B.mat', 'data_input_output_09B');
