...
% file path
file1 = 'Gazebo_data_csv/sim_mpc_sin_0930B/imu_data.csv';
file2 = 'Gazebo_data_csv/sim_mpc_sin_0930B/attitude_r_p_y.csv';
file3 = 'Gazebo_data_csv/sim_mpc_sin_0930B/actuator_control.csv';
file4 = 'Gazebo_data_csv/sim_mpc_sin_0930B/input_x_y_z.csv';
file5 = 'Gazebo_data_csv/sim_mpc_sin_0930B/pose.csv';
...
matrix_imu_data = matrix_imu_data(51:end,:);
figure(5); hold on;
