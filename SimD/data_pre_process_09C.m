...
% file path
file1 = 'Gazebo_data_csv/sim_mpc_exp_1006C/imu_data.csv';
file2 = 'Gazebo_data_csv/sim_mpc_exp_1006C/attitude_r_p_y.csv';
file3 = 'Gazebo_data_csv/sim_mpc_exp_1006C/actuator_control.csv';
file4 = 'Gazebo_data_csv/sim_mpc_exp_1006C/input_x_y_z.csv';
file5 = 'Gazebo_data_csv/sim_mpc_exp_1006C/pose.csv';
...
matrix_input_x_y_z = matrix_input_x_y_z(50:end,:);
...
plot(matrix_actuator_control(:,5)-matrix_input_x_y_z(:,5),'g.');
plot(matrix_actuator_control(:,6)-matrix_input_x_y_z(:,6),'b.');
hold off;

matrix_imu_data = matrix_imu_data(44:end,:);
figure(5); hold on;
...
matrix_attitude_r_p_y = matrix_attitude_r_p_y(50:end,:);
figure(6); hold on;
...
data_input_output_09C = [actuator_control_x, actuator_control_y, actuator_control_z, ...
...
Pstart01 = 3000;
Pend01 = 15000;
% data_input_output_09C = data_input_output_09C(Pstart01:Pend01 , :);
% save('./Gazebo_data_mat/data09C.mat', 'data_input_output_09C');
