...
% file path
file1 = 'Gazebo_data_csv/mpc_sin_0926B/imu_data.csv';
file2 = 'Gazebo_data_csv/mpc_sin_0926B/attitude_r_p_y.csv';
file3 = 'Gazebo_data_csv/mpc_sin_0926B/actuator_control.csv';
file4 = 'Gazebo_data_csv/mpc_sin_0926B/input_x_y_z.csv';
file5 = 'Gazebo_data_csv/mpc_sin_0926B/pose.csv';
...
matrix_imu_data = matrix_imu_data(31:end,:);
figure(5); hold on;
...
data_input_output_07B = [actuator_control_x, actuator_control_y, actuator_control_z, ...
