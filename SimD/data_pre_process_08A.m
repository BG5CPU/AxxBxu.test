...
% file path
file1 = 'Gazebo_data_csv/sim_mpc_sin_0930A/imu_data.csv';
file2 = 'Gazebo_data_csv/sim_mpc_sin_0930A/attitude_r_p_y.csv';
file3 = 'Gazebo_data_csv/sim_mpc_sin_0930A/actuator_control.csv';
file4 = 'Gazebo_data_csv/sim_mpc_sin_0930A/input_x_y_z.csv';
file5 = 'Gazebo_data_csv/sim_mpc_sin_0930A/pose.csv';
...
% matrix_input_x_y_z = matrix_input_x_y_z(2:end,:);
...
matrix_imu_data = matrix_imu_data(52:end,:);
figure(5); hold on;
plot(flipud(matrix_actuator_control(:,3)), 'r.'); % flipud
plot(flipud(matrix_imu_data(:,1)), 'g.');
hold off;
...
data_input_output_08A = [actuator_control_x, actuator_control_y, actuator_control_z, ...
...
Pstart01 = 500;
Pend01 = 20500;
data_input_output_08A = data_input_output_08A(Pstart01:Pend01 , :);
save('./Gazebo_data_mat/data08A.mat', 'data_input_output_08A');
