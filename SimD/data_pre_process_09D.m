...
% file path
file1 = 'Gazebo_data_csv/sim_mpc_exp_1006D/imu_data.csv';
file2 = 'Gazebo_data_csv/sim_mpc_exp_1006D/attitude_r_p_y.csv';
file3 = 'Gazebo_data_csv/sim_mpc_exp_1006D/actuator_control.csv';
file4 = 'Gazebo_data_csv/sim_mpc_exp_1006D/input_x_y_z.csv';
file5 = 'Gazebo_data_csv/sim_mpc_exp_1006D/pose.csv';
...
matrix_imu_data = matrix_imu_data(652:end,:);
figure(5); hold on;
plot((matrix_actuator_control(:,3)), 'r.'); % flipud
plot((matrix_imu_data(:,3)), 'g.');
hold off;


% matrix_attitude_r_p_y = matrix_attitude_r_p_y(50:end,:);
matrix_input_x_y_z = matrix_input_x_y_z(3:end,:);
matrix_actuator_control = matrix_actuator_control(3:end,:);
figure(6); hold on;
...
data_input_output_09D = [actuator_control_x, actuator_control_y, actuator_control_z, ...
