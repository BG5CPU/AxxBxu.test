...
% file path
file1 = 'Gazebo_data_csv/mpc_sin_0926A/imu_data.csv';
...
figure(1); hold on;
plot(matrix_input_x_y_z(:,1), 'r.');
plot(matrix_input_x_y_z(:,3), 'g.');
hold off;

figure(2); 
plot(matrix_actuator_control(:,1)-matrix_input_x_y_z(:,1), 'r.');
...
matrix_imu_data = matrix_imu_data(40:end,:);
figure(6); hold on;
...
velocity_angle_x = interpolate_to_match_A(matrix_input_x_y_z(:,3), matrix_imu_data(:,[1,8]));
velocity_angle_y = interpolate_to_match_A(matrix_input_x_y_z(:,3), matrix_imu_data(:,[1,9]));
velocity_angle_z = interpolate_to_match_A(matrix_input_x_y_z(:,3), matrix_imu_data(:,[1,10]));
...
data_input_output_06 = [actuator_control_x, actuator_control_y, actuator_control_z, ...
...
Pstart01 = 4530;
Pend01 = 9230;
% data_input_output_06 = data_input_output_06(Pstart01:Pend01 , :);
% save('./Gazebo_data_mat/data06.mat', 'data_input_output_06');
